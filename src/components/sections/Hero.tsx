...
export const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Network visualization - more subtle */}
      ...
      {/* Main content - Awwwards style layout */}
      <div className="container mx-auto px-6 md:px-12 lg:px-16 z-10 relative w-full">
        <div className="grid grid-cols-12 gap-8 items-center min-h-screen py-20">
          {/* Left side - Main text */}
          <div className="col-span-12 lg:col-span-7 space-y-12">
            {/* TAHEER - Massive, bold */}
            <div style={{ perspective: '1000px' }}>
              <h1 className="text-[15vw] sm:text-[12vw] md:text-[10vw] lg:text-[8vw] xl:text-[7rem] font-black leading-[0.85] tracking-tighter text-black dark:text-white">
            ...
            <div className="hero-role">
              <motion.div
                ...
                className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 dark:text-gray-400 tracking-wide"
              >
                {roles[currentRole]}
              </motion.div>
            </div>
            ...
            <div className="hero-cta flex flex-wrap gap-4 items-center pt-4">
              <button
                onClick={() => {
            ...
            <div className="flex items-center gap-6 text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest pt-8">
          ...
          <div className="col-span-12 lg:col-span-5 flex items-center justify-center lg:justify-end">
            <motion.div
              ...
              transition={{ duration: 1.5, delay: 1, ease: 'expo.out' }}
              className="relative w-64 h-64 md:w-80 md:h-80"
            >
              {/* Animated circle accent */}
              <div className="absolute inset-0 border border-gray-200 dark:border-gray-800 rounded-full" />
              <div className="absolute inset-4 border border-gray-300 dark:border-gray-700 rounded-full animate-spin-slow" />
              <div className="absolute inset-8 border border-gray-400 dark:border-gray-600 rounded-full animate-spin-reverse" />
